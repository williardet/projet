...
<body>
    ...
    <main>
        <div class="card-header" style="text-decoration:underline;">
            <h2 class="fs-4">Ajout de categorie</h2>
        </div>
        <form action="<?= WEBROOT ?>" method="POST" class="d-flex mt-2 mb-3">
                <div class="w-50">
                    <input type="text" name="nomCat" id="" class="form-control w-80" placeholder="Atouter categorie..." aria-describedby="helpId" />
                </div>
                <button style="background-color: #9A7450; color:white;font-size:18px;" type="submit" class="btn">Ajouter</button>
                <input type="hidden" name="controlleur" value="categorie">
                <input type="hidden" name="action" value="add-categorie">
        </form>
        <div class="card-header" style="text-decoration:underline;">
            <h2 class="fs-4">Listes les categories</h2>
        </div>
